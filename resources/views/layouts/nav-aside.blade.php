    ...
    <ul class="side-menu app-sidebar3">
        ...
        @if (config('settings.wizard_feature_user') == 'allow')
            <li class="slide">
                ...
                <span class="side-menu__label">{{ __('AI Article Wizard') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li> 
        @endif
        @if (config('settings.smart_editor_feature_user') == 'allow')
            <li class="slide">
                ...
                <span class="side-menu__label">{{ __('Smart Editor') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li> 
        @endif
        @if (config('settings.rewriter_feature_user') == 'allow')
            <li class="slide">
                ...
                <span class="side-menu__label">{{ __('AI ReWriter') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li> 
        @endif
        @if (config('settings.video_feature_user') == 'allow')
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a href="{{ route('user.video') }}" class="slide-item">{{ __('Image to Video') }} <span class="text-primary fs-9 side-menu__new ml-6">{{ __('New') }}</span></a></li>
                </ul>
            </li> 
        @endif
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    @if (config('settings.voice_clone_feature_user') == 'allow')
                        <li><a href="{{ route('user.voiceover.clone') }}" class="slide-item">{{ __('Voice Cloning') }}<span class="text-primary fs-9 side-menu__new ml-6">{{ __('New') }}</span></a></li>
                    @endif
                    @if (config('settings.sound_studio_feature_user') == 'allow')
                        <li><a href="{{ route('user.studio') }}" class="slide-item">{{ __('Sound Studio') }}<span class="text-primary fs-9 side-menu__new ml-6">{{ __('New') }}</span></a></li>
                    @endif
                </ul>
            </li> 
        @endif
        ...
        @if (config('settings.chat_file_feature_user') == 'allow')
            <li class="slide">
                ...
                <span class="side-menu__label">{{ __('AI File Chat') }}</span><span class="text-primary fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li> 
        @endif
